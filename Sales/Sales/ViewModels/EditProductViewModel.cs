    ...
    public class EditProductViewModel : BaseViewModel
    {
        ...
        private async void Save()
        {
            ...
            var response = await this.apiService.Put(
                ...
                controller,
                this.Product,
                this.Product.ProductId, Settings.TokenType, Settings.AccessToken);
            ...
            var productsViewModel = ProductsViewModel.GetInstance();
            var oldProduct = productsViewModel.MyProducts.
                Where(p => p.ProductId == this.Product.ProductId).FirstOrDefault();
            if (oldProduct != null)
            {
                productsViewModel.MyProducts.Remove(oldProduct);
            }

            productsViewModel.MyProducts.Add(modifiedProduct);
            productsViewModel.RefreshList();
